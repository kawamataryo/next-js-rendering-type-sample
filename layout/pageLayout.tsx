  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://my-chakra-app.kawamataryo.vercel.app/"
        />
        <meta property="og:description" content="" />
        <meta property="og:type" content="article" />
        <meta
          property="og:image"
          content={`https://my-chakra-app.kawamataryo.vercel.app/ogp-${type}.png`}
        />
        <meta
          property="og:description"
          content="Sample application of the Next.js rendering types."
        />
      </Head>
